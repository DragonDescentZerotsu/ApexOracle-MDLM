...
class MIC_regressor(nn.Module):
    ...
    def load_genome_test_embedding(self):
        ATCC_genome_emb_dict = load_all_genome_embeddings(
            ...
            # Path('/data2/tianang/projects/Ben_ApexOracle_test/DataPrepare/Data/GenomeEmb'),  # TODO: Change to need
            1e14,
            'cpu',
        ...
        ATCC_text_emb_dict = load_all_genome_embeddings(
            ...
            # Path('/data2/tianang/projects/Ben_ApexOracle_test/DataPrepare/Data/TextEmb'),  # TODO: Change to need
            1,
            'cpu',
            'ATCC text embedding')
...
def get_mic(file_names, mic_regressor, tokenizer, strain, target_MIC, guidance_method=None, target_length=None):
...
if __name__ == '__main__':
    ...
    # ckpt_path = '/data2/tianang/projects/Synergy/Checkpoints/genome_text_learnable_emb/all_AMP_SM_data_train/MDLM_MTR_fix_cls_wo_pad/all_data_best_R2_epoch_25.pth'
    # ckpt_path = '/data2/tianang/projects/Synergy/Checkpoints/genome_text_learnable_emb/strain_wise_w_SM_b_attn/MDLM_MTR_fix_mean_wo_pad_eval_1_fold_ensembles/genome_text_learnable_emb_Strain_wise_best_R2_group_1_ensemble_0.pth'
    ...
    # length = '320'
    lengths = list(range(256, 416+1, 4))
    # lengths = list(range(340, 416 + 1, 4))
    # lengths = [144, 224, 232, 238, 246, 256, 272, 280, 320, 328, 336, 340, 344, 352, 356]
    target_MICs = ['1']  # '1000' 表示 unconditional generation
    generate_mol_save_dir = Path('/data2/tianang/projects/mdlm/temp_data/milk')
    ...
    for strain, strain_show_name in zip(strains, strain_show_names):
        ...
        for target_MIC in target_MICs:
            ...
            # save_image
            img_save_dir = Path(f'/data2/tianang/projects/mdlm/temp_data/milk_pred_img-2/strain_{file_strain}')
        ...
        # img_save_dir.mkdir(parents=True, exist_ok=True)
        selfies_save_dir = Path('/data2/tianang/projects/mdlm/temp_data/milk_pred-2')
        selfies_save_dir.mkdir(parents=True, exist_ok=True)
        with open(selfies_save_dir/f'strain_{strain}.txt', 'w') as f:
