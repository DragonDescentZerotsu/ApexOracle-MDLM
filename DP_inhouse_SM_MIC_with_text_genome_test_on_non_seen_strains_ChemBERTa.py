...
if __name__ == '__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / f'strain_wise_w_SM_b_attn' / f'MDLM_MTR_{num_ensembles}_fold_ensembles'
    ...
    for i, (strain_for_train, strain_for_test, test_group_name) in enumerate(zip(train_groups, test_groups, group_names)):
        ...
        for ensemble in tqdm(range(num_ensembles), desc=' Doing ensembles '):
            ...
            optimizer.add_param_group({'params': mdlm_model.parameters(), 'lr': 1e-6, 'weight_decay': args.weight_decay*0.1})   # TODO: ChemBERTa 和别的学习率不一样
