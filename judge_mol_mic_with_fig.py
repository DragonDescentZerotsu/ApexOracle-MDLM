...
if __name__ == '__main__':
    ...
    strain_show_names = ['BS60', 'BS66', 'BS70', 'BS86']
    strains = ['BS60', 'BS66', 'BS70', 'BS86']
    # length = '320'
    ...
    generate_mol_save_dir = Path('/data2/tianang/projects/discrete-diffusion-guidance/outputs/generated_mol_SELFIES-new')
    ...
    for length in lengths:
        ...
        for strain, strain_show_name in zip(strains, strain_show_names):
            ...
            for target_MIC in target_MICs:
                ...
                img_save_dir = Path(f'/data2/tianang/projects/discrete-diffusion-guidance/outputs/generated_mol_img_w_mic/strain_{file_strain}/MIC_{file_target_MIC}/length_{file_target_length}')
            ...
            with open(selfies_save_dir/f'strain_{strain}_MIC_{target_MICs[0]}_length_{length}_noise.txt', 'w') as f:
