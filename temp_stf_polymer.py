...
if __name__ == '__main__':
    ...
    # Load polymer data
    polymer_data_path = Path('temp_data/polymers_lit_scraped.csv')
    polymer_data = pd.read_csv(polymer_data_path)
    ...
    for smiles in tqdm(all_monomers, desc='Processing monomers'):
        try:
            ...
            monomer_dict[smiles] = tokens['input_ids'].squeeze(0)
            valid_count += 1
