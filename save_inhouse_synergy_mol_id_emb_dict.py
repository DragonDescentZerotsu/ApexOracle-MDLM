...
if __name__ == '__main__':
    ...
    # Evo_strain_FICI_data_path = current_directory / 'DataPrepare' / 'Data' / 'inhouse_synergy'/'processed'/'inhouse_synergy_Evo_smiles_seq.csv'  # 'DBAASP_id_bact_name_SMILES_MIC_Evo.csv'
    Evo_strain_FICI_data_path = current_directory / 'DataPrepare' / 'Data' / 'inhouse_synergy' / 'processed' / 'combine_create_inhouse_synergy_Evo_smiles_seq.csv'
    ...
    torch.save(mol_emb, current_directory / 'DataPrepare' / 'Data' / f'combine_create_synergy_inhouse_mol_emb_dict_{pooling_method}.pt')
