...
if __name__ == '__main__':
    ckpt_cb = ModelCheckpoint(
        dirpath="cls-guide-pad-no-mask-checkpoints-v2",
    ...
    wandb_logger = WandbLogger(
        project="Pep_SM_Classification_v2",  # W&B 中的项目名
        name="run1",  # 本次运行的显示名称
    ...
    dataset_path = '/data2/tianang/projects/Synergy/DataPrepare/MDLM/Data/hf_pep_SM_cls_1024_v2'
    ...
    pos_rate = 0.0008861772425766144 #num_pos / (num_neg + num_pos)
    neg_rate = 0.9991138227574233 #num_neg / (num_neg + num_pos)
    # pos_rate = num_pos / (num_neg + num_pos)
    # neg_rate = num_neg / (num_neg + num_pos)
    ...
    trainer.fit(model, train_loader, val_loader,
                # ckpt_path='/data2/tianang/projects/mdlm/cls-guide-pad-no-mask-checkpoints-v2/last.ckpt'
                )
